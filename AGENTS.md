...
This file is the quick-reference operating contract for tonic-kotlin. The longer
...
tonic-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tonic`](https://crates.io/crates/tonic). Upstream Rust is the behavioral oracle while the
