...
kotlin {
    ...
    val xcf = XCFramework("Tonic")

    macosArm64 {
        binaries.framework { baseName = "Tonic"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Tonic"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Tonic"
        flattenPackage = "io.github.kotlinmania.tonic"
    }

    android {
        namespace = "io.github.kotlinmania.tonic"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tonic-kotlin", version.toString())

    pom {
        name.set("tonic-kotlin")
        description.set("Kotlin Multiplatform port of hyperium/tonic - A gRPC over HTTP/2 implementation focused on high performance, interoperability, and flexibility")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tonic-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tonic-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tonic-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tonic-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/tonic/codeql/_CodeqlEmptySource.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.tonic.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTonicXCFramework",
    "assembleTonicDebugXCFramework",
    "assembleTonicReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTonicXCFramework",
    "assembleReleaseIosFatFrameworkForTonicXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTonicXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTonicXCFramework",
    "assembleDebugMacosFatFrameworkForTonicXCFramework",
    "assembleReleaseMacosFatFrameworkForTonicXCFramework",
    "assembleDebugTvosFatFrameworkForTonicXCFramework",
    "assembleReleaseTvosFatFrameworkForTonicXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTonicXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTonicXCFramework",
    "assembleDebugWatchosFatFrameworkForTonicXCFramework",
    "assembleReleaseWatchosFatFrameworkForTonicXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTonicXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTonicXCFramework",
