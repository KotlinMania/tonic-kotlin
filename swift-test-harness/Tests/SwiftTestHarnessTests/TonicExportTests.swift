...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Tonic.swiftmodule/`
...
//      `import Tonic` above would fail at compile time.
//
//   2. The static archive `libTonic.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Tonic" }` and
//      `flattenPackage = "io.github.kotlinmania.tonic"` configuration in
